...
import { SteamAppActionType, ValidateError } from "@src/enums"
import { insertOne } from "@src/api/SteamManager/users"
...
const Modal: React.FC<ModalProps> = (props) => {
	...
	const saveModal = () => {
		...
		insertOne(steam_id, windows_name)
			.then((user) => {
				props.dispatch({type: SteamAppActionType.NEW, data: user as WindowsSteamUserNumbered})
	...
	useEffect(() => {
		...
		console.log("windows_users: ", props.steamAppState.windows_users)
